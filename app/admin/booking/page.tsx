...
export default function AdminBookingPage() {
  ...
  if (success) return (
    <div style={{ padding: '2rem', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '60vh' }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <h2 style={{ fontSize: '20px', fontWeight: 700, color: '#1e293b', marginBottom: '0.5rem' }}>Order berhasil dibuat!</h2>
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '600px' }}>
      <h1 style={{ fontSize: '22px', fontWeight: 700, color: '#1e293b', marginBottom: '0.25rem' }}>Booking Manual</h1>
      <p style={{ fontSize: '14px', color: '#64748b', marginBottom: '2rem' }}>Input order dari telepon atau WA klien</p>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        ...
        <button type="submit" disabled={loading} style={{
          padding: '12px', background: loading ? '#94a3b8' : '#3b82f6', color: '#fff',
